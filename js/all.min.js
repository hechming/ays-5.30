...
window.onload=function(){$(".rtpart").find(".fch").hover(function(){$(this).css("background","#fff"),$(".list-unstyled").show(1,function(){$(".list-unstyled").find("li").hover(function(){$(this).find("a").css("color","red")},function(){$(this).find("a").css("color","gray")})}),$(".fch").find(".myLove").css("color","red")},function(){$(this).css("background","none"),$(".list-unstyled").hide(),$(".fch").find(".myLove").css("color","gray")}),$(".foch-3").hover(function(){},function(){})};
